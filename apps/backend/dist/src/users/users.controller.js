...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Deactivate a user (from ACTIVE to INACTIVE)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Block a user (from ACTIVE to BLOCKED)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Unblock a user (from BLOCKED to ACTIVE)' }),
    (0, swagger_1.ApiParam)({ name: 'id', description: 'User ID' }),
