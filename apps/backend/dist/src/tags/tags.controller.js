...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get a tag by name' }),
    (0, swagger_1.ApiQuery)({ name: 'name', description: 'Tag name' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Tag ID' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Tag found' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Tag not found' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Tag not found' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Tag name already exists' }),
    __param(0, (0, common_1.Param)('id')),
